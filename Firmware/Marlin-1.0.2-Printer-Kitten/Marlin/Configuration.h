...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,1600,462}  // 434 for 1.75mm, 462 for 3mm
#define DEFAULT_MAX_FEEDRATE          {150, 150, 15, 55}    // (mm/sec) for Z 75 for 1.75, 55 for 3mm
