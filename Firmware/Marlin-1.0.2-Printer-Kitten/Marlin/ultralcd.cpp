...
void lcd_purge()
{
  ...
  enquecommand_P(PSTR("G1 F600"));
  enquecommand_P(PSTR("G1 E5"));
}
...
void lcd_load_filament()
{
  ...
  enquecommand_P(PSTR("G1 E200 F10000"));
  enquecommand_P(PSTR("G1 E200"));
  enquecommand_P(PSTR("G1 E150"));
  //lcd_return_to_status();
}
...
{
  enquecommand_P(PSTR("M83"));
  enquecommand_P(PSTR("G1 E-200 F10000"));
  enquecommand_P(PSTR("G1 E-200"));
  enquecommand_P(PSTR("G1 E-200"));
  //lcd_return_to_status();
}
...
static void lcd_prepare_menu()
{
  ...
  #endif
#endif
    MENU_ITEM(function, "Purge 5mm", lcd_purge);
    MENU_ITEM(function, "Retract 5mm", lcd_retract);
    MENU_ITEM(gcode, MSG_DISABLE_STEPPERS, PSTR("M84"));
    MENU_ITEM(function, "Home", lcd_home);
    MENU_ITEM(function, MSG_SET_HOME_OFFSETS, lcd_set_home_offsets);
    //MENU_ITEM(gcode, MSG_SET_ORIGIN, PSTR("G92 X0 Y0 Z0"));
    MENU_ITEM(function, MSG_COOLDOWN, lcd_cooldown);
    MENU_ITEM(function, "Load Filament", lcd_load_filament);
    MENU_ITEM(function, "Unload Filament", lcd_unload_filament);
